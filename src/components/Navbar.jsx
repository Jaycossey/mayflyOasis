...
const Navbar = ({ loading }) =>(
  ...
  <nav className="fixed z-10 flex items-center justify-between w-full h-20 bg-white border-2 border-black">
    ...
    <div className="flex items-center justify-center w-full max-w-xs mx-auto lg:w-auto lg:mx-0 lg:justify-end">
      <NavLink to="/Home" className="px-16 py-2 text-black rounded lg:mx-2 lg:my-0">Home</NavLink>
      <NavLink to="/about" className="px-6 py-2 text-black rounded lg:mx-2 lg:my-0">About</NavLink>
      <NavLink to="/contact" className="px-16 rounded py-26text-black lg:mx-2 lg:my-0">Contact</NavLink>
    </div>
  </nav>
)
