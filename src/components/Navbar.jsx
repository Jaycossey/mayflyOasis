...
const Navbar = ({ loading }) => {
  ...
  return loading ? null : (
    <nav className='fixed w-full h-24 bg-white border-2 border-white'>
      <img src={Logo} alt='MFO Logo' className='w-auto h-32 mx-4 logo' />
      <button
  className='right-0 block lg:hidden'
