...
const PRODUCTS = [
  ...
  },
  {
    ...
    description:
      'Textured black and gold spiral, embodying the intricacies of the cosmic dance between light and dark.',
    year: 2020,
    medium: 'Acrylic',
    dimensions: '20x20 cm',
    price: 100,
  },
  {
    ...
    description:
      'Abstract canvas featuring layered textures, with golden highlights which shimmer on a rich and dark backdrop.',
    year: 2022,
    medium: 'Photography',
  ...
  },
  {
    ...
    description:
      'A Textured triptych, featuring an interplay of light and shadow, tactile ridges, juxtaposing black, white, and metallic gold.',
    year: 2018,
  ...
  },
  {
    ...
    description: "Graphic design piece of the Brighton Pier.",
    year: 2017,
  ...
  },
  {
    ...
    description: 'Sculptural representation of the Yorkshire Dales.',
    year: 2020,
    medium: 'Bronze',
  ...
  },
  {
    ...
    description: 'A Photographic journey along the mesmerising scenic Welsh coastline.',
    year: 2022,
    medium: 'Photography',
  ...
  },
  {
    ...
    artist: 'Harry Davis',
    images: [S1, S2, S3, S4],
    description: "A linocut print reflecting Sheffield's long lineage of industrial heritage.",
    year: 2018,
    medium: 'Linocut Print',
    dimensions: '45x35 cm',
    price: 160,
  },
  {
    ...
    description: 'Textile artwork depicting the busy Aberdeen harbor. A beautiful mix of mediums.',
    year: 2022,
    medium: 'Mixed Textiles',
    dimensions: '50x50 cm',
    price: 230,
